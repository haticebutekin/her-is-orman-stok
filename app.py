...
.box{background:#111827;padding:15px;border-radius:10px;margin:10px}
input,button,select{padding:12px;font-size:18px;margin:5px;width:95%}
.big{font-size:28px}
</style>
</head>
